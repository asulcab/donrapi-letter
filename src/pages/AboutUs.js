...
export default class AboutUs extends Component {
    ...
    state = {
        services: [
            {
                info: 
                    "Chambits “LO QUIERES LO TIENES”, somos huancaínos, brindamos servicios de Transportes diversos realizados mediante Motorizados, armado y mantenimiento de muebles, instalación de cámaras de video vigilancia. Cumplimos los requerimientos de nuestros clientes de manera rápida, segura y confiable. Tenemos en cuenta que cada servicio es una posibilidad de progreso mutuo, es por ello que nos esforzamos día a día por entregar servicios de calidad con una gestión profesional y adecuada a las necesidades de cada cliente. Somos un equipo innovador, dinámico, con una constante búsqueda y ejecución de nuevas formas de soluciones, con el fin de mejorar la satisfacción de nuestros clientes. Somos el socio ideal en brindar soluciones integrales a tus necesidades, con responsabilidad, calidad y seguridad.",
                district: "Huancayo",
                name: "Chambits",
                type: "Trabajo",
                speciality: "Trabajo",
